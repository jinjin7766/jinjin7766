...
<body>
    <div class="container">
        <h1>저출산 원인 분석</h1>
        <img src="https://github.com/jinjin7766/Portfolio/blob/main/SQL_%ED%91%9C%EC%A7%80.png" alt="SQL Project" class="cover-image">
        <p>이 프로젝트는 저출산 문제의 원인을 분석하고 SQL 쿼리를 활용하여 데이터를 시각화한 프로젝트입니다. 주요 내용은 다음과 같습니다:</p>
        <ul>
            <li>SQL을 사용한 데이터 전처리</li>
            <li>Tableau를 이용한 시각화</li>
            <li>분석 결과를 바탕으로 정책 제안</li>
        </ul>
        <p>PDF 파일을 보고 싶으시면 아래 버튼을 눌러주세요:</p>
        <a href="https://github.com/jinjin7766/Portfolio/blob/main/11%EC%A1%B0_%EB%B0%95%EC%A7%84%EC%9A%B0_%EC%A1%B0%ED%98%9C%EC%A0%95.pdf" class="back-link">PDF 보기</a>
